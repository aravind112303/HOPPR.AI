...
function SignUp() {
  ...
  return (
    ...
    <form className='w-[90%] h-[600px] max-w-[500px] bg-[#00000023] backdrop-blur shadow-lg shadow-black-200 flex flex-col items-center justify-center gap-[20px] px-[20px]' onSubmit={handleSignUp}>
    <h1 className='text-white text-[30px] font-semibold mb-[30px]'>Register to <span className='text-blue-700'>HOPPR</span>.AI</h1>
    ...
    <p className='text-white text-[18px] cursor-pointer'>Alreadly have an account ? <span className='text-blue-700 hover:text-blue-400' onClick={()=>navigate("/signin")}>Sign In</span></p>
    </form>
